...
/**
 * Resizable-array implementation of the MyList and MyStack interfaces.
 * @author David Zhang
 * @version 2.0.2 October 3, 2024
 */
public class MyArrayList<E> implements MyList<E>, MyStack<E> {
    ...
    public E pop() throws StackException {
        if (size == 0)
            throw new StackException("Attempt to pop from an empty stack.");
    ...
    public E peek() throws StackException {
        if (size == 0)
            throw new StackException("Attempt to peek at an empty stack.");
