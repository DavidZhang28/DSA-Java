...
public class MyLinkedList<E> implements MyList<E> {
    ...
    public void reverse()
    {
        ...
        Node prevv = head; Node prev = prevv.next; Node curr = prev.next;
        tail = prevv;
        prevv.next = null;
    ...
    /* This was a pretty creative recursive method but it's O(n) space unfortunately
    public void reverse()
    {
        if (head == null || head.next == null)
            return;
        tail = reverseHelper(head);
        tail.next = null;
    }
    
    public Node reverseHelper(Node n)
    {
        if (n.next == null)
        {
            head = n;
